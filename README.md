...
Это уже не только сухой симулятор, а визуальная песочница для проверки логики:
- какие тайлы открываются;
- где лежат спаун-тайлы;
- где появляются динозавры;
- как они идут по био-тропам;
- где стоят ловушки;
- где ходят рейнджеры;
- почему отчёт показывает именно такие цифры, а не магию из болота.
